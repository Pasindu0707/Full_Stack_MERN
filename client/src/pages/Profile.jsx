    ...
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
        ...
        <img
          ...
          alt="Profile"
          className='mt-2 cursor-pointer h-24 w-24 self-center rounded-full object-cover'
      ...
      <p className='text-green-700 mt-5'>{updateSuccess && 'User us updated Successfully'}</p>
    </div>
  );
}
